    ...
    inline namespace DX11
    {
        namespace Private
        {
            ...
            protected:
                ...
                DIRECTX_TOOLKIT_API void __cdecl Draw(D3D11_PRIMITIVE_TOPOLOGY topology,
                    bool                                                       isIndexed,
        ...
        public:
            explicit PrimitiveBatch(_In_ ID3D11DeviceContext* deviceContext,
            ...
            void DrawIndexed(D3D11_PRIMITIVE_TOPOLOGY  topology,
            ...
            void DrawTriangle(TVertex const& v1, TVertex const& v2, TVertex const& v3)
            {
                ...
                PrimitiveBatchBase::Draw(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST,
                    false,
                    nullptr,
                    0,
                    3,
