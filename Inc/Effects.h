...
namespace DirectX
{
    inline namespace DX11
    {
        ...
        public:
            ...
            DIRECTX_TOOLKIT_API void __cdecl GetVertexShaderBytecode(_Out_ void const** pShaderByteCode,
        ...
        public:
            ...
            DIRECTX_TOOLKIT_API void __cdecl SetSurfaceTextures(_In_opt_ ID3D11ShaderResourceView* albedo,
            ...
            SetIBLTextures(_In_opt_ ID3D11ShaderResourceView* radiance, int numRadianceMips, _In_opt_ ID3D11ShaderResourceView* irradiance);
        ...
        public:
            ...
            virtual std::shared_ptr<IEffect> __cdecl CreateEffect(_In_ const EffectInfo& info, _In_opt_ ID3D11DeviceContext* deviceContext)
                = 0;

            virtual void __cdecl CreateTexture(_In_z_ const wchar_t* name,
        ...
        public:
            ...
            DIRECTX_TOOLKIT_API std::shared_ptr<IEffect> __cdecl CreateEffect(_In_ const EffectInfo& info,
                _In_opt_ ID3D11DeviceContext*                                                        deviceContext) override;
            DIRECTX_TOOLKIT_API void __cdecl                     CreateTexture(_In_z_ const wchar_t* name,
                                    _In_opt_ ID3D11DeviceContext*                                    deviceContext,
        ...
        public:
            ...
            DIRECTX_TOOLKIT_API virtual std::shared_ptr<IEffect> __cdecl CreateDGSLEffect(_In_ const DGSLEffectInfo& info,
                _In_opt_ ID3D11DeviceContext*                                                                        deviceContext);

            DIRECTX_TOOLKIT_API virtual void __cdecl CreatePixelShader(_In_z_ const wchar_t* shader,
