...
namespace DirectX
{
    inline namespace DX11
    {
        ...
        public:
            ...
            DIRECTX_TOOLKIT_API SpriteFont(_In_ ID3D11Device* device, _In_z_ wchar_t const* fileName, bool forceSRGB = false);
            DIRECTX_TOOLKIT_API SpriteFont(_In_ ID3D11Device* device,
                _In_reads_bytes_(dataSize) uint8_t const*     dataBlob,
                _In_ size_t                                   dataSize,
                bool                                          forceSRGB = false);
            DIRECTX_TOOLKIT_API SpriteFont(_In_ ID3D11ShaderResourceView* texture,
            ...
            DIRECTX_TOOLKIT_API SpriteFont(_In_ ID3D11Device* device, _In_z_ __wchar_t const* fileName, bool forceSRGB = false);
