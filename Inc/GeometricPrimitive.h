    ...
    inline namespace DX11
    {
        ...
        public:
            ...
            DIRECTX_TOOLKIT_API static std::unique_ptr<GeometricPrimitive> __cdecl CreateCylinder(_In_ ID3D11DeviceContext* deviceContext,
                ...
                bool   rhcoords = true);
            DIRECTX_TOOLKIT_API static std::unique_ptr<GeometricPrimitive> __cdecl CreateCone(_In_ ID3D11DeviceContext* deviceContext,
                float                                                                                                   diameter     = 1,
                float                                                                                                   height       = 1,
                size_t                                                                                                  tessellation = 32,
                bool                                                                                                    rhcoords = true);
            DIRECTX_TOOLKIT_API static std::unique_ptr<GeometricPrimitive> __cdecl CreateTorus(_In_ ID3D11DeviceContext* deviceContext,
                float                                                                                                    diameter  = 1,
            ...
            // Draw the primitive.
            DIRECTX_TOOLKIT_API void XM_CALLCONV Draw(FXMMATRIX world,
                CXMMATRIX                                       view,
            ...
            DIRECTX_TOOLKIT_API void __cdecl Draw(_In_ IEffect* effect,
                _In_ ID3D11InputLayout*                         inputLayout,
                bool                                            alpha     = false,
                bool                                            wireframe = false,
                _In_ std::function<void __cdecl()> setCustomState         = nullptr) const;

            DIRECTX_TOOLKIT_API void __cdecl DrawInstanced(_In_ IEffect* effect,
                _In_ ID3D11InputLayout*                                  inputLayout,
            ...
            DIRECTX_TOOLKIT_API void __cdecl CreateInputLayout(_In_ IEffect* effect, _Outptr_ ID3D11InputLayout** inputLayout) const;

            DIRECTX_TOOLKIT_API static inline void SetDepthBufferMode(bool reverseZ) { s_reversez = reverseZ; }
