...
HRESULT CommonStates::Impl::CreateBlendState(D3D11_BLEND srcBlend, D3D11_BLEND destBlend, _Outptr_ ID3D11BlendState** pResult)
{
...
HRESULT
CommonStates::Impl::CreateDepthStencilState(bool enable, bool writeEnable, bool reverseZ, _Outptr_ ID3D11DepthStencilState** pResult)
{
...
HRESULT
CommonStates::Impl::CreateRasterizerState(D3D11_CULL_MODE cullMode, D3D11_FILL_MODE fillMode, _Outptr_ ID3D11RasterizerState** pResult)
{
...
HRESULT
CommonStates::Impl::CreateSamplerState(D3D11_FILTER filter, D3D11_TEXTURE_ADDRESS_MODE addressMode, _Outptr_ ID3D11SamplerState** pResult)
{
...
{
    return DemandCreate(pImpl->opaque,
        pImpl->mutex,
...
{
    return DemandCreate(pImpl->alphaBlend,
        pImpl->mutex,
        [&](ID3D11BlendState** pResult)
        {
...
{
    return DemandCreate(pImpl->additive,
        pImpl->mutex,
        [&](ID3D11BlendState** pResult)
        {
...
{
    return DemandCreate(pImpl->nonPremultiplied,
        pImpl->mutex,
        [&](ID3D11BlendState** pResult)
        {
...
{
    return DemandCreate(pImpl->depthNone,
        pImpl->mutex,
...
{
    return DemandCreate(pImpl->depthDefault,
        pImpl->mutex,
        [&](ID3D11DepthStencilState** pResult)
        {
...
{
    return DemandCreate(pImpl->depthRead,
        pImpl->mutex,
        [&](ID3D11DepthStencilState** pResult)
        {
...
{
    return DemandCreate(pImpl->depthReverseZ,
        pImpl->mutex,
        [&](ID3D11DepthStencilState** pResult)
        {
...
{
    return DemandCreate(pImpl->depthReadReverseZ,
        pImpl->mutex,
        [&](ID3D11DepthStencilState** pResult)
        {
...
{
    return DemandCreate(pImpl->cullNone,
        pImpl->mutex,
...
{
    return DemandCreate(pImpl->cullClockwise,
        pImpl->mutex,
        [&](ID3D11RasterizerState** pResult)
        {
...
{
    return DemandCreate(pImpl->cullCounterClockwise,
        pImpl->mutex,
        [&](ID3D11RasterizerState** pResult)
        {
...
{
    return DemandCreate(pImpl->wireframe,
        pImpl->mutex,
        [&](ID3D11RasterizerState** pResult)
        {
...
{
    return DemandCreate(pImpl->pointWrap,
        pImpl->mutex,
...
{
    return DemandCreate(pImpl->pointClamp,
        pImpl->mutex,
        [&](ID3D11SamplerState** pResult)
        {
...
{
    return DemandCreate(pImpl->linearWrap,
        pImpl->mutex,
        [&](ID3D11SamplerState** pResult)
        {
...
{
    return DemandCreate(pImpl->linearClamp,
        pImpl->mutex,
        [&](ID3D11SamplerState** pResult)
        {
...
{
    return DemandCreate(pImpl->anisotropicWrap,
        pImpl->mutex,
        [&](ID3D11SamplerState** pResult)
        {
...
{
    return DemandCreate(pImpl->anisotropicClamp,
        pImpl->mutex,
        [&](ID3D11SamplerState** pResult)
        {
