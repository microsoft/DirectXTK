...
namespace
{
    ...
    void LockBuffer(_In_ ID3D11DeviceContext* deviceContext,
        _In_ ID3D11Buffer*                    buffer,
        size_t                                currentPosition,
        _Out_ size_t*                         basePosition,
        _Out_ D3D11_MAPPED_SUBRESOURCE*       mappedResource)
    {
...
_Use_decl_annotations_ void PrimitiveBatchBase::Impl::Draw(D3D11_PRIMITIVE_TOPOLOGY topology,
    bool                                                                            isIndexed,
...
void PrimitiveBatchBase::Impl::FlushBatch()
{
    ...
    if (mCurrentlyIndexed)
    {
        ...
        mDeviceContext->DrawIndexed(static_cast<UINT>(mCurrentIndex - mBaseIndex),
...
// Custom draw method.
_Use_decl_annotations_ void PrimitiveBatchBase::Draw(D3D11_PRIMITIVE_TOPOLOGY topology,
    bool                                                                      isIndexed,
    uint16_t const*                                                           indices,
    size_t                                                                    indexCount,
    size_t                                                                    vertexCount,
